...
<body id="page-top">
  ...
  <div class="container">
    ...
    <div class="mb-4" style="text-align:center"><h4>ĐĂNG KÝ HỌC VIÊN</h4></div>
    <!-- FORM INSERT -->
    ...
    <div class="input-group mb-1">
      ...
      <input type="text" class="form-control only-number" id="sdt" name="sdt" placeholder="Đây là SĐT để liên lạc cho việc học">
    </div>
    ...
    <div class="form-group" style="text-align:center">
      <button class="btn btn-danger" type="submit" id="btn-dangky-hv">Đăng ký</button>
    </div>
    <!-- END FORM-->
  </div>
