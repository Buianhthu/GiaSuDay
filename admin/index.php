                            ...
                            <tbody id="content">
                                ...
                                while ($row = mysqli_fetch_row($result)) { 
                                    ...
                                    if($row[10]== 1)
                                    {
                                        ...
                                        echo '<td><button class="icon" data-id="' . $row[0] . '" onclick="huyduyetdkgs(this)"><i class="fas fa-times-circle " style="color:#4e73df"></i></button>';
                                    }
                                    else
                                    {
                                        echo"<td>chưa kiểm duyệt</td>";
                                        echo '<td><button class="icon" data-id="' . $row[0] . '" onclick="duyetdkgs(this)"><i class="fas fa-check-circle " style="color:#4e73df"></i></button>';
                                    }
