                ...
                <div id="main">
                    <div class="container">
                        ...
                        while ($row = $result->fetch_array()) 
                        {
                            ...
                            echo '<li class = "list-group-item"><strong>Số Điện Thoại: </strong>' . $row['SDT_TV'] . '</li>';
                            ...
                            if ($row['KiemDuyet'] == '1') {
                                ...
                                echo '<button class="icon mt-5  data-id="' . $row['Id'] . '" onclick="huyduyetreviewgs(this)">Hủy kiểm duyệt</button>';
                            } else {
                                echo '<li class = "list-group-item"><strong>Kiểm Duyệt: </strong>chưa kiểm duyệt</li>';
                                echo '<button class="icon mt-5  data-id="' . $row['Id'] . '" onclick="duyetreviewgs(this)">kiểm duyệt</button>';
                            }
                            echo '</ul>';
                        }
                        ?>
