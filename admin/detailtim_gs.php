                    ...
                    <div class="container">
                        ...
                        while ($row = $result->fetch_array()) 
                        {
                            ...
                            if ($row['KiemDuyet'] == '1') {
                                ...
                                echo '<button class="icon mt-5" data-id="' . $row['Id'] . '" onclick="huyduyettimgs(this)">Hủy kiểm duyệt</button>';
                            } else {
                                echo '<li class = "list-group-item"><strong>Kiểm Duyệt: </strong>chưa kiểm duyệt</li>';
                                echo '<button class="icon mt-5" data-id="' . $row['Id'] . '" onclick="duyettimgs(this)">kiểm duyệt</button>';
                            }
                            echo '</ul>';
                        }
                        ?>
