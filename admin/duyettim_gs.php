...
<head>
    ...
    <script type="text/javascript">
        function huyduyettimgs(temp) {
            ...
            xhttp.open("GET", "controllers/huyduyettimgs.php?id=" + SDT_GS, true);
            xhttp.send();
        }
            ...
            function duyettimgs(temp) {
                ...
                xhttp.open("GET", "controllers/duyettimgs.php?id=" + SDT_GS, true);
                xhttp.send();
            }
    </script>
                                ...
                                while ($row = mysqli_fetch_row($result)) {  /*
                                    ...
                                    */
                                    ...
                                    if($row[8]== 1)
                                    {
                                        ...
                                        echo '<td><button class="icon" data-id="' . $row[0] . '" onclick="huyduyettimgs(this)"><i class="fas fa-times-circle " style="color:#4e73df"></i></button>';
                                    }
                                    else
                                    {
                                        echo"<td>chưa kiểm duyệt</td>";
                                        echo '<td><button class="icon" data-id="' . $row[0] . '" onclick="duyettimgs(this)"><i class="fas fa-check-circle " style="color:#4e73df"></i></button>';
                                    }
                                    
                                    echo '<button class="icon"><a class="icon" href="detailtim_gs.php?id='.$row[0].'"> <i class="fas fa-info-circle"></i></a></button>';
                                    echo "</tr>";
                                }
